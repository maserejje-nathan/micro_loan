...
class ReportController extends Controller
{
    public function index(): JsonResponse
    {
        ...
        $repaymentsByMonth = Repayment::query()
            ->get()
            ->groupBy(fn ($repayment) => $repayment->paid_at->format('Y-m'))
        ...
        return response()->json([
            ...
            'statement_loans' => $statementLoans,
            'portfolio' => [
            ...
            'disbursements_by_month' => $disbursementsByMonth,
            'repayments_by_month' => $repaymentsByMonth,
        ]);
    }
}
